...
export const AboutScreen: React.FC<AboutScreenProps> = ({ onOpenStory, onOpenContact }) => {
  ...
  return (
    <div className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-16">
          {TEAM_MEMBERS.map((member, idx) => (
            <div
              key={idx}
              className="group bg-white rounded-3xl overflow-hidden border border-stone-200/80 shadow-xs hover:shadow-lg transition flex flex-col"
            >
        ...
        <div className="bg-[#FAF7F2] p-8 rounded-3xl border border-stone-200 text-center max-w-3xl mx-auto space-y-4">
        ...
        <div className="mt-14 p-6 sm:p-8 bg-stone-100/70 rounded-2xl border border-stone-200/60 max-w-4xl mx-auto">
      ...
      <section className="bg-[#FAF7F2] py-16 sm:py-24 border-y border-stone-200/70">
